...
Мы рассматриваем различные варианты лицензирования, чтобы сделать продукт максимально доступным и честным для наших пользователей. Точная информация о ценообразовании и бизнес-модели будет анонсирована ближе к первому публичному релизу.
